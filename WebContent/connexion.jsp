...
<body>
	...
	<div class="container">
			...
			<div class="row">
				...
				<div class="container col-sm-8 shadow-lg p-4 mb-4 bg-success text-white" style="background: ">

					<h1 >BIENVENUE</h1>
					<p>La plateforme de gestion des inscriptions de <font size="4" class="font-weight-bold text-dark">l'ECOLE FRANCO ARABE ALHIDAYA</font>.</p>
