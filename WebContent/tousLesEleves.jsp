	...
	<br><br>
		...
		<nav class="navbar navbar-expand-sm bg-dark navbar-dark">
	 		<form class="form-inline" method="post" action="tousLesEleves">
	   			<input class="form-control mr-sm-2" type="search" placeholder="tapez le nom d'un élève" name="nomEleve">
    			...
    			<table class="table table-bordered table-secondary">
      				...
      				<c:forEach items="${v1}" var="line">
          				...
          				<td>
	   						...
	   						<button class="btn btn-primary" onclick="window.location.href = 'misAjourEleve?idEleve=${line.getIdEleve()}';" >Mettre à jour</button>
	   					</td>
